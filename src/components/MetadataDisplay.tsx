...
/**
 * This component creates multiple expandable tabs containg tables for each 
 * metadata type. Only the types in metadataTypes will be displayed, even if 
 * metadata contains additional types. @param props The data for the tables. The
 * metadata should be organized in a dictionary mapping metadata type IDs 
 * (not names!) to metadata arrays.
 * @returns A series of expandable panels containing the metadata in tables.
 */
function MetadataDisplay<P extends MetadataTyped, V extends MetadataTagged>
