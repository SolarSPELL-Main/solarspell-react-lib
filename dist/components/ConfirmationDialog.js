...
function ConfirmationDialog(_a) {
    ...
    return (_jsx(GenericDialog, Object.assign({ title: props.title, description: props.description, size: size, open: props.open, onClose: disagree, actions: (_jsxs(_Fragment, { children: [_jsx(Button, Object.assign({ onClick: disagree, color: cancelColor }, props.cancelAdditionalProps, { children: cancelText }), void 0), _jsx(Button, Object.assign({ onClick: agree, color: confirmColor }, props.confirmAdditionalProps, { children: confirmText }), void 0)] }, void 0)), additionalProps: {
